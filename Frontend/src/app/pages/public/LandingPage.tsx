  ...
  const testimonials = [
    {
      ...
      quote:
        'FleetOps transformed our operations. We reduced fuel costs by 23% in the first quarter alone.',
      name: 'Sarah Mitchell',
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Join thousands of fleet managers who trust FleetOps
            </p>
          </motion.div>
